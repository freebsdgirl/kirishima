...
if [ -f /consul/config/stickynotes-service.json.template ]; then
    envsubst < /consul/config/stickynotes-service.json.template > /consul/config/stickynotes-service.json
fi
